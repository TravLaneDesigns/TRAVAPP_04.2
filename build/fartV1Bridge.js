export function fartV1Bridge() {
  return {
    ...
    transform(code, id) {
      ...
      const homeMarkerComponent = `function HomeMarkerText({ children, className = "" }) {\n  const text = String(children);\n  const markerFont = '\"Permanent Marker\", \"Arial Black\", Impact, sans-serif';\n  return (\n    <>\n      <style>{\`@import url('https://fonts.googleapis.com/css2?family=Permanent+Marker&display=swap');\`}</style>\n      <span\n        className={\`relative inline-block \${className}\`}\n        style={{\n          fontFamily: markerFont,\n          fontWeight: 400,\n          letterSpacing: '-0.055em',\n          lineHeight: 0.9,\n          transform: 'rotate(-1.4deg) skewX(-4deg)',\n          transformOrigin: 'center',\n          isolation: 'isolate',\n        }}\n      >\n        <span\n          aria-hidden=\"true\"\n          className=\"absolute inset-0 select-none\"\n          style={{\n            transform: 'translate(2.3px, 1.4px) rotate(.35deg)',\n            opacity: 0.28,\n            filter: 'blur(.28px)',\n            mixBlendMode: 'multiply',\n            WebkitTextStroke: '1.5px currentColor',\n          }}\n        >{text}</span>\n        <span\n          aria-hidden=\"true\"\n          className=\"absolute inset-0 select-none\"\n          style={{\n            transform: 'translate(-1.1px, -.7px) rotate(-.25deg)',\n            opacity: 0.20,\n            mixBlendMode: 'multiply',\n            WebkitTextStroke: '.9px currentColor',\n          }}\n        >{text}</span>\n        <span\n          className=\"relative\"\n          style={{\n            WebkitTextStroke: '.55px currentColor',\n            textShadow: '.7px 0 currentColor, -.5px .8px rgba(0,0,0,.22)',\n            filter: 'contrast(1.08)',\n          }}\n        >{text}</span>\n        <span\n          aria-hidden=\"true\"\n          className=\"absolute inset-0 select-none pointer-events-none\"\n          style={{\n            color: 'transparent',\n            backgroundImage: 'repeating-linear-gradient(104deg, rgba(255,255,255,.00) 0 7px, rgba(255,255,255,.15) 8px 9px, rgba(0,0,0,.10) 10px 11px, rgba(255,255,255,.00) 12px 18px)',\n            WebkitBackgroundClip: 'text',\n            backgroundClip: 'text',\n            WebkitTextStroke: '.35px rgba(0,0,0,.05)',\n            opacity: .9,\n            mixBlendMode: 'overlay',\n            transform: 'translate(.4px,.2px)',\n          }}\n        >{text}</span>\n      </span>\n    </>\n  );\n}\n\n`;
